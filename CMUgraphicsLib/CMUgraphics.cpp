...
void window::DrawQuad(const int iX1, const int iY1, const int iX2, const int iY2, const int iX3, const int iY3, const int iX4, const int iY4, const drawstyle dsStyle)
{
	HRGN rgnTemp;
